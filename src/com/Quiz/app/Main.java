...
public class Main {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		 ...
		 quiz q = new quiz("Quiz JAVA",DateTimeFormatter.ofPattern("2020/04/16 05:00:00"));
		 
		 Niveau N1 = new Niveau(1);
		 Niveau N2 = new Niveau(2);
		 Niveau N3 = new Niveau(3);
		 ...
		 List<Question> Qte = new ArrayList<Question>();
		 int cpt = 0,fin = 3;
         for(int i =0;i<15;i++) {
    	...
    	JLabel qte = new JLabel(Qte.get(0).getDesc());
    	//JLabel Nve = new JLabel("Niveau 1");
    	qte.setBounds(40,40,500,50);
        Pl.add(qte);
        int y = 80;
        for(int i = 0;i<3;i++) {
        	JRadioButton radioButton1;
        	radioButton1	= new JRadioButton(Qte.get(0).getChoix().get(i).getDesc());
        	radioButton1.setActionCommand(Qte.get(0).getChoix().get(i).getDesc());
        ...
        JLayeredPane Pll = new JLayeredPane();
		...
		class Listner implements ActionListener{
			...
			try {
				...
				//traitement panel
				JLabel qte = new JLabel(Qte.get(q.getQ()).getDesc());
		    	qte.setBounds(40,40,500,50);
		    	//Pl.resetKeyboardActions();
		    	Pl.removeAll();
		        Pl.add(qte);
		        int y = 80;
		        for(int i = 0;i<3;i++) {       	
		        		JRadioButton radioButton1;
			        	radioButton1	= new JRadioButton(Qte.get(q.getQ()).getChoix().get(i).getDesc());
			        	radioButton1.setActionCommand(Qte.get(q.getQ()).getChoix().get(i).getDesc());
			        	buttonGroup.add(radioButton1);
			        	radioButton1.setBounds(40,y,500,30);
			        	y+=30;
			        	Pl.add(radioButton1);
		        }
